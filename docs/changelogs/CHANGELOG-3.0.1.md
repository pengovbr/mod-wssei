...
* [Instalação](../v3.0.1/docs/INSTALACAO.md) - Procedimento de instalação do módulo
* [Atualização](../v3.0.1/docs/ATUALIZACAO.md) - Procedimento detalhados para atualização de uma versão anterior.
...
| 5.0.0, 5.0.1, 5.0.2, 5.0.3            | mod-wssei 3.0.x         |	
...
#### Permite subir da versão 2.2.1

Realizadas alterações necessárias para subir da versão 2.2.1 do módulo.

### Atualização de Versão

#### Pré-requisitos

Versão 5.0.0 até 5.0.3 do **SEI** instalado (verificar valor da constante de versão no arquivo sei/web/SEI.php).
