...
class MdWsSeiServicosV3 extends MdWsSeiVersaoServicos
{
    ...
    {
        /**
         * Grupo para a versao v3 de servicos REST
         */
        $this->slimApp->group('/api/v3', function () {
            ...
            })->add(new TokenValidationMiddlewareV3());
            /**
            ...
            $this->post('/autenticar', function ($request, $response, $args) {
                ...
                if ($request->getParam('unidade')) {
                    $unidadeDTO->setNumIdUnidade($request->getParam('unidade'));
                }

                $orgaoDTO->setNumIdOrgao($request->getParam('orgao'));

                return $response->withJSON($rn->apiAutenticarV3($usuarioDTO, $orgaoDTO, $unidadeDTO));
            });
            /**
