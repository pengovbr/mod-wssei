...
class MdWsSeiUsuarioRN extends InfraRN {
    ...
    private function getSecret(){
        ...
        if((!$token) || (strlen($token)<32)){
            throw new InfraException('Token Secret inexistente ou tamanho menor que o permitido! Verifique o manual de instala��o do m�dulo.');
        }
    ...
    /**
     * M�todo que retorna os perfis do usu�rio
    ...
    protected function listarUsuariosConectado(UnidadeDTO $unidadeDTOParam){
        try{
            ...
            //Pagina��o l�gica pois o SIP n�o retorna os usu�rios paginados...
    ...
    /**
     * Altera a unidade atual do Usu�rio
     * @param $idUnidade
     */
    ...
    /**
     * Retorna as unidades do usu�rio
     * @param UsuarioDTO $usuarioDTO
     */
